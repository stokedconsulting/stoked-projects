...
exports.initializeBranchManager = initializeBranchManager;
exports.getBranchManager = getBranchManager;
exports.cleanupBranchManager = cleanupBranchManager;
...
class BranchManager {
     ...
     */
    getBranchName(agentId, issueNumber) {
     ...
     */
    async createAgentBranch(agentId, issueNumber) {
     ...
     */
    async pushAgentBranch(agentId, issueNumber) {
        const branchName = this.getBranchName(agentId, issueNumber);
        try {
     ...
     */
    async checkForConflicts(agentId, issueNumber) {
        const branchName = this.getBranchName(agentId, issueNumber);
        try {
     ...
     */
    showConflictNotification(branchName, conflictingFiles, rebaseAttempted) {
        ...
        vscode.window.showWarningMessage(message, 'View Conflicts', 'Resolve Manually').then(selection => {
 ...
 */
let globalBranchManager = null;
/**
 * Initialize the global branch manager instance
 * @param workspaceRoot - Root directory of the workspace
 */
function initializeBranchManager(workspaceRoot) {
