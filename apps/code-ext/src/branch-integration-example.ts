...
export async function exampleAgentWorkflow(
    ...
    // Initialize managers
    const branchManager = new BranchManager(workspaceRoot);
 ...
 */
export async function exampleMultiAgentWorkflow(workspaceRoot: string): Promise<void> {
 ...
 */
export async function exampleConflictScenarios(
    workspaceRoot: string,
    agentId: number,
    issueNumber: number
): Promise<void> {
 ...
 */
export function getIntegrationUsageExample(): string {
    return `
