...
export class ClaudeAPI {
    ...
    constructor() {
        this.tempDir = path.join(os.tmpdir(), 'gh-projects-claude');
     ...
     */
    public async executeDesignAnalysis(projectDescription: string): Promise<string> {
     ...
     */
    public async executeProjectBreakdown(approvedDesign: string): Promise<string> {
...
Think deeply about edge cases, scalability, security implications, and maintainability.`;
     ...
     */
    private buildIterationPrompt(previousResult: string, feedback: string): string {
