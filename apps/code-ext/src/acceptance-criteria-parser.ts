import { ReviewResult, CriterionResult } from './review-agent';

/**
 * Single acceptance criterion with status and validation results
 */
export interface AcceptanceCriterion {
    id: string;           // Auto-generated: "AC-1", "AC-2", etc.
...
/**
 * Validation result after checking criteria against review results
 */
export interface ValidationResult {
    allMet: boolean;
    metCount: number;
    totalCount: number;
    unmetCriteria: AcceptanceCriterion[];
}

/**
 * Overall criteria status summary
 */
 ...
 */
export function formatCriteriaForPrompt(criteria: AcceptanceCriterion[]): string {
 ...
 */
export function getCriteriaStatus(criteria: AcceptanceCriterion[]): CriteriaStatus {
 ...
 */
export function getNoCriteriaMessage(): string {
